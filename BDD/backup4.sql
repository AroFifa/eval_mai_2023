...
COPY brand (id, brand_name) FROM stdin;
8	Toshiba
6	FUJITSU
2	Dell
3	Apple
...
SELECT pg_catalog.setval('public.commission_level_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.mouvement_id_seq', 59, true);
...
SELECT pg_catalog.setval('public.purchase_id_seq', 21, true);
...
SELECT pg_catalog.setval('public.reception_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.sale_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.stock_id_seq', 57, true);
...
SELECT pg_catalog.setval('public.transfer_id_seq', 16, true);
