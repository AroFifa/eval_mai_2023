...
CREATE FUNCTION public.getprofitmonthsales(minyear integer, maxyear integer) RETURNS TABLE(month numeric, sale numeric, purchase numeric, loss numeric, profit numeric)
    LANGUAGE plpgsql
    AS $$
BEGIN
  RETURN QUERY
...
CREATE VIEW public.v_monthly_mvt AS
 SELECT v_monthly_mvt_tmp.month,
    v_monthly_mvt_tmp.year,
    v_monthly_mvt_tmp.sale,
    v_monthly_mvt_tmp.purchase,
    v_monthly_mvt_tmp.transfer,
    v_monthly_mvt_tmp.reception,
    (v_monthly_mvt_tmp.transfer - v_monthly_mvt_tmp.reception) AS loss,
    ((v_monthly_mvt_tmp.sale + v_monthly_mvt_tmp.reception) - (v_monthly_mvt_tmp.purchase - v_monthly_mvt_tmp.transfer)) AS profit
   FROM public.v_monthly_mvt_tmp;
...
20	0.00	0.00	18750000.00	0.00	\N	2020-05-02
21	0.00	0.00	62500000.00	0.00	\N	2021-05-05
22	0.00	0.00	45000000.00	0.00	\N	2021-09-10
23	0.00	0.00	101250000.00	0.00	\N	2022-06-14
24	0.00	0.00	123750000.00	0.00	\N	2023-05-02
25	0.00	0.00	0.00	15000000.00	\N	2020-05-04
4	0.00	75000000.00	0.00	0.00	\N	2019-05-06
5	0.00	50000000.00	0.00	0.00	\N	2019-05-06
6	0.00	81000000.00	0.00	0.00	\N	2019-05-06
7	0.00	30600000.00	0.00	0.00	\N	2019-05-06
8	0.00	143000000.00	0.00	0.00	\N	2019-05-06
9	0.00	126000000.00	0.00	0.00	\N	2019-05-06
10	0.00	106400000.00	0.00	0.00	\N	2019-05-06
11	0.00	105600000.00	0.00	0.00	\N	2019-05-06
12	0.00	244200000.00	0.00	0.00	\N	2019-05-06
13	0.00	42000000.00	0.00	0.00	\N	2019-05-06
\.
...
2	1	50	1500000.00	2019-05-06	9
3	2	25	2000000.00	2019-05-06	9
4	3	30	2700000.00	2019-05-06	9
5	4	18	1700000.00	2019-05-06	9
6	5	65	2200000.00	2019-05-06	9
7	6	42	3000000.00	2019-05-06	9
8	7	56	1900000.00	2019-05-06	9
9	8	44	2400000.00	2019-05-06	9
10	9	74	3300000.00	2019-05-06	9
11	10	20	2100000.00	2019-05-06	9
\.
...
18	2020-05-02	1	1	0	10
19	2021-05-05	1	2	0	25
20	2021-09-10	1	6	0	12
21	2022-06-14	1	3	0	30
22	2023-05-02	1	5	0	45
23	2020-05-04	6	1	8	0
2	2019-05-06	1	1	50	0
3	2019-05-06	1	2	25	0
4	2019-05-06	1	3	30	0
5	2019-05-06	1	4	18	0
6	2019-05-06	1	5	65	0
7	2019-05-06	1	6	42	0
8	2019-05-06	1	7	56	0
9	2019-05-06	1	8	44	0
10	2019-05-06	1	9	74	0
11	2019-05-06	1	10	20	0
\.
...
7	2020-05-02	9	6	1	1	10
8	2021-05-05	9	7	1	2	25
9	2021-09-10	9	7	1	6	12
10	2022-06-14	9	8	1	3	30
11	2023-05-02	9	7	1	5	45
\.
...
SELECT pg_catalog.setval('public.laptop_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.model_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.mouvement_id_seq', 25, true);
...
SELECT pg_catalog.setval('public.transfer_id_seq', 11, true);
