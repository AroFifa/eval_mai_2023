...
export default function EmployeeAffectation() {
  ...
  //   const affectSelectInput = (params) => {
  //     function affect(event, params) {
  //       event.preventDefault();
  //       const value = selectionedValue.current.value
  //         ? selectionedValue.current.value
  //         : params.row.store.id;
  //       affectEmployee(params.row.id, value);
  //     }
  ...
  //       type: "data",
  //       placeholder: "Points de vente",
  //       ref: selectionedValue,
  //       defaultValue: params.row.store.id,
  //       fullWidth: true,
  //       onchange: affect(event, params),
  //       data: {
  //         data: salesPoints,
  //         label: "store_name",
  //         value: "id",
